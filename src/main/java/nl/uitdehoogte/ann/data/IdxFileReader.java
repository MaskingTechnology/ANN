...
public class IdxFileReader implements IdxReader 
{
	...
	public IdxFileReader(String idx1FileName, String idx3FileName) 
	{
	...
	{	
		return samples[currentSampleIndex++ % samples.length];
	}
